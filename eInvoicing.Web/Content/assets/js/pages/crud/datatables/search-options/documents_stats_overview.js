...
var initTable1 = function () {
	...
	table.DataTable({
		...
		ajax: {
			url: '/efatorty/v1/report/AjaxGetSubmittedDocumentsStatsOverview',
			type: 'POST',
			data: function (post) {
		...
		columns: [
			{ data: "issuedOn", "name": "IssuedOn", "width" : "100px" },
			...
			{ data: "totalItemsDiscountAmount", "name": "TotalItemsDiscountAmount" }
