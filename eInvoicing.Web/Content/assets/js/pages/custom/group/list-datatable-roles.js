...
function deleteRole(id, name) {
    Swal.fire({
        ...
        if (result.value) {
            KTApp.blockPage();
            $.ajax({
                url: "/eimc.hub/v1/role/deleterole?id=" + id,
                type: "POST",
                dataType: 'json',
...
function editRole(id) {
    $.ajax({
        url: "/eimc.hub/v1/role/editpartial?id=" + id,
        type: "GET",
        data: {},
        success: function (response) {
    ...
    $("#RoleSubmission").click(function (e) {
        _roleFrm.validate().then(function (status) {
            if (status == 'Valid') {
                ...
                $.ajax({
                    url: "/eimc.hub/v1/role/createrole",
                    type: "POST",
                    dataType: 'json',
                    contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                    data: valdata,
