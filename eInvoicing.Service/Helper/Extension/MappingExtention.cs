    ...
    internal static class MappingExtention
    {
        ...
        internal static DocumentVM ToDocumentVM(this Document document)
        {
            return new DocumentVM()
            {
                ...
                taxAmount = (document.TotalSalesAmount - document.NetAmount).ToString("N0"),
                netAmount = document.NetAmount.ToString("N0"),
                totalAmount = document.TotalAmount.ToString("N0"),
                totalDiscountAmount = document.TotalDiscountAmount.ToString("N0"),
                totalItemsDiscountAmount = document.TotalItemsDiscountAmount.ToString("N0"),
                totalSalesAmount = document.TotalSalesAmount.ToString("N0"),
                extraDiscountAmount = document.ExtraDiscountAmount.ToString("N0"),
                ...
                invoiceLines = document.InvoiceLines.Select(i => new INVOICELINESVM()
                {
                    ...
                    itemCode = i.ItemCode,
                    itemsDiscount = i.ItemsDiscount.ToString("N0"),
                    itemType = i.ItemType,
                    netTotal = i.NetTotal.ToString("N0"),
                    quantity = i.Quantity.ToString("N2"),
                    salesTotal = i.SalesTotal.ToString("N0"),
                    total = i.Total.ToString("N0"),
                    totalTax = i.TaxableItems.Sum(x => x.Amount).ToString("N0"),
                    totalTaxableFees = i.TotalTaxableFees.ToString("N0"),
                    unitType = i.UnitType,
                    valueDifference = i.ValueDifference.ToString("N0"),
                    internalId = i.Id,
                    ...
                    discount = new DISCOUNTSVM() { amount = i.DiscountAmount.ToString("N0"), rate = i.DiscountRate.ToString("N0") },
                    unitValue = new UNITVALUESVM() { amountEGP = i.AmountEGP.ToString("N0"), amountSold = i.AmountSold.ToString("N0"), currencyExchangeRate = i.CurrencyExchangeRate.ToString("N0"), currencySold = i.CurrencySold }
                }).ToList(),
